(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Erika Carvalho da Silva'));
    ...
    */
    console.log( '\nReplace de datas:' );
    var replaceDate = text.replace(regexDate, function($1, $2, $3, $4) {
        return $1 + '/' + getMonthNumber($3) + '/' + $4;
    });
