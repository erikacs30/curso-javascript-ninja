(function() {
    ...
    */
    ...
    console.log('sum', sum(43, 12, 13, 54, 7));
    console.log('sum', sum(121, 32));
    ...
    */
    ...
    function justNumbers ( phrase ) {
        return phrase.replace(/\D+/g, '#').split('#');
    }
    ...
    */
    ...
    var arrNumber = justNumbers(userEntry);
    console.log(arrNumber);
    console.log(sum.apply(sum, arrNumber));
})();