(function () {
    ...
    */
    ...
    var regexHtmlOpen = /<\w+>/g,
        htmlOpen = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
    console.log(htmlOpen.match(regexHtmlOpen));
    ...
    */
    ...
    var regexHtmlEmpty = /<\w+><\/\w+>/g,
        htmlEmpty = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
    console.log(htmlEmpty.match(regexHtmlEmpty));
